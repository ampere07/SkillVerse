      ...
      return [
        {
          ...
          description:
            "Learn to work with variables and data types by creating a student profile system. Store and display information like name, age, GPA, and enrollment status.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Master arithmetic and comparison operators by building a basic calculator. Perform operations and compare results.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Practice if-else statements by creating a grade evaluation system. Convert numeric scores to letter grades.",
          language: "Java",
      ...
      return [
        {
          ...
          description:
            "Learn to work with variables and data types by creating a personal information system. Store and display different types of data.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Master Python operators by building a mathematical operations tool. Perform calculations and comparisons.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Practice if-elif-else statements by creating a score classification system. Categorize scores into performance levels.",
          language: "Python",
      ...
      return [
        {
          ...
          description:
            "Learn interfaces and polymorphism by creating a payment processing system. Implement multiple payment methods with a common interface.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Master Java Collections Framework by building an inventory management system. Use ArrayList, HashMap, and HashSet.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Practice exception handling by creating a console-based logging system. Handle various error scenarios gracefully.",
          language: "Java",
      ...
      return [
        {
          ...
          description:
            "Master dictionaries and sets by building a contact management system. Store and search contacts efficiently.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Learn functional programming with map, filter, and reduce. Transform and analyze data functionally.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Practice decorators by creating function enhancement utilities. Add logging, timing, and validation.",
          language: "Python",
      ...
      return [
        {
          ...
          description:
            "Implement the Factory design pattern to create different types of database connections. Demonstrate creational pattern expertise.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Master concurrent programming by implementing a custom thread pool executor. Manage task execution efficiently.",
          language: "Java",
        ...
        },
        {
          ...
          description:
            "Analyze and optimize algorithm performance. Compare different sorting algorithms and measure efficiency.",
          language: "Java",
      ...
      return [
        {
          ...
          description:
            "Implement the Observer pattern for an event notification system. Demonstrate advanced OOP design.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Create a simple ORM framework using metaclasses. Demonstrate advanced Python meta-programming.",
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Implement an asynchronous task scheduler using async/await. Master concurrent programming patterns.",
          language: "Python",
...
export const generateWeeklyProjects = async (userId) => {
  try {
    ...
    const projects = await generateProjectsForLanguage(
      userId,
...
export const generateProjectsForBothLanguages = async (userId) => {
  try {
    ...
    console.log(
      `[ProjectGen] ========== GENERATING PROJECTS FOR BOTH LANGUAGES ==========`,
    );
    ...
    console.log(
      `[ProjectGen] Calling generateProjectsForLanguage for JAVA (Phase ${userPhase})...`,
    );
    const javaProjects = await generateProjectsForLanguage(
      userId,
      "java",
      userPhase,
    );
    ...
    if (javaProjects.length > 0) {
      console.log(`[ProjectGen] Sample Java project:`, {
        title: javaProjects[0].title,
        language: javaProjects[0].language,
      });
    }

    console.log(
      `[ProjectGen] Calling generateProjectsForLanguage for PYTHON (Phase ${userPhase})...`,
    );
    const pythonProjects = await generateProjectsForLanguage(
      userId,
      "python",
      userPhase,
    );
    console.log(
      `[ProjectGen] Python projects generated:`,
      pythonProjects.length,
    );
    if (pythonProjects.length > 0) {
      console.log(`[ProjectGen] Sample Python project:`, {
        title: pythonProjects[0].title,
        language: pythonProjects[0].language,
      });
    }

    const allProjects = [...javaProjects, ...pythonProjects];
    console.log(
      `[ProjectGen] Generated ${javaProjects.length} Java + ${pythonProjects.length} Python = ${allProjects.length} total projects`,
    );
    console.log(
      `[ProjectGen] ================================================================`,
    );
...
export const generateProjectsForLanguage = async (
  userId,
  language,
  userPhase = 1,
) => {
  try {
    ...
    if (!survey) {
      throw new Error(
        `No survey found for user ${userId} and language ${language}`,
      );
    }
    ...
    if (
      !survey.learningRoadmap ||
      !survey.learningRoadmap.phase1 ||
      survey.learningRoadmap.phase1.length < 3
    ) {
    ...
    console.log(
      `[ProjectGen] ========== GENERATING ROADMAP-BASED PROJECTS ==========`,
    );
    console.log(`[ProjectGen] User ID: ${userId}`);
    ...
    console.log(
      `[ProjectGen] Roadmap Phase 1: ${survey.learningRoadmap.phase1.join(", ")}`,
    );
    console.log(
      `[ProjectGen] Roadmap Phase 2: ${survey.learningRoadmap.phase2.join(", ")}`,
    );
    console.log(
      `[ProjectGen] Roadmap Phase 3: ${survey.learningRoadmap.phase3.join(", ")}`,
    );
    ...
    console.log(
      `[ProjectGen] Has AI Analysis: ${!!languageSpecificSurvey.aiAnalysis}`,
    );
    if (languageSpecificSurvey.aiAnalysis) {
      console.log(
        `[ProjectGen] AI Analysis preview:`,
        languageSpecificSurvey.aiAnalysis.substring(0, 200),
      );
    }
    ...
    console.log(
      `[ProjectGen] AI Response length: ${projectsText.length} characters`,
    );
    console.log(
      `[ProjectGen] AI Response preview (first 500 chars):`,
      projectsText.substring(0, 500),
    );

    const projects = parseProjectsFromAI(projectsText);
    console.log(
      `[ProjectGen] Parsed ${projects.length} projects from AI response`,
    );

    if (projects.length > 0) {
      console.log(
        `[ProjectGen] First parsed project:`,
    ...
    if (correctedProjects.length < 3) {
      throw new Error(
        `Only generated ${correctedProjects.length} projects, expected at least 3.`,
      );
    }

    console.log(
      `[ProjectGen] Successfully generated ${correctedProjects.length} roadmap-based projects in ${duration}s`,
    );
...
const determineSkillLevel = (
  ...
  console.log(
    `[SkillLevel] Java expertise: ${javaExpertise}, Python expertise: ${pythonExpertise}`,
  );
  console.log(
    `[SkillLevel] Java score: ${javaScore?.percentage}%, Python score: ${pythonScore?.percentage}%`,
  );

  if (scores.length === 0) {
    if (javaExpertise === "expert" || pythonExpertise === "expert") {
      console.log(
        `[SkillLevel] Determined: Advanced (based on self-assessment)`,
      );
      return "Advanced";
    }
    if (
      javaExpertise === "intermediate" ||
      pythonExpertise === "intermediate"
    ) {
      console.log(
        `[SkillLevel] Determined: Intermediate (based on self-assessment)`,
      );
      return "Intermediate";
    }
...
const parseProjectsFromAI = (text) => {
  ...
  let projectMatches = text
    .split(/###\s*Project\s*\d+:/i)
    .filter((p) => p.trim());
  ...
  console.log(
    `[ProjectGen-Parse] Found ${projectMatches.length} potential project blocks`,
  );
  ...
  for (const projectText of projectMatches) {
    try {
      ...
      const descMatch = projectText.match(
        /(?:\*\*)?Description:(?:\*\*)?\s*(.+?)(?=(?:\*\*)?Language|$)/is,
      );
      const langMatch = projectText.match(
        /(?:\*\*)?Language:(?:\*\*)?\s*(.+?)(?=\n|$)/i,
      );
      const reqMatch = projectText.match(
        /(?:\*\*)?Requirements:(?:\*\*)?\s*([\s\S]+?)(?=(?:\*\*)?Rubrics:|$)/i,
      );
      const rubricsMatch = projectText.match(
        /(?:\*\*)?Rubrics:(?:\*\*)?\s*([\s\S]+?)(?=\n\n|###|PROJECT|$)/i,
      );
      ...
      if (titleMatch && descMatch && langMatch) {
        ...
        const requirements = reqMatch
          ? reqMatch[1]
              ...
              .filter(
                (r) =>
                  r.trim() &&
                  (r.trim().startsWith("-") || r.trim().match(/^\d+\./)),
              )
              .map((r) => r.trim())
              .join("\n")
          : "";
        ...
        console.log(
          `[ProjectGen-Parse] Project "${title}" fields: Req=${!!reqMatch}, Rubrics=${!!rubricsMatch}`,
        );
