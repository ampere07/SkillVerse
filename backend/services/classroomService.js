...
export const classroomService = {
  ...
  async getTeacherClassrooms(teacherId) {
    ...
    .populate('teacher', 'name firstName middleInitial lastName email')
    .populate('students.studentId', 'name firstName middleInitial lastName email')
    .sort({ createdAt: -1 });
  },
  ...
  async createClassroom(data) {
    ...
    await classroom.populate('teacher', 'name firstName middleInitial lastName email');
    return classroom;
  },
  ...
  async updateClassroom(classroomId, data) {
    ...
    await classroom.populate('teacher', 'name firstName middleInitial lastName email');
    await classroom.populate('students.studentId', 'name firstName middleInitial lastName email');
